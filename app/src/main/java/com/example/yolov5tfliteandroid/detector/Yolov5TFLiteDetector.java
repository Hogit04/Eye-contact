...
public class Yolov5TFLiteDetector {
    ...
    private final int[] OUTPUT_SIZE = new int[]{1, 25200, 16};
    ...
    private final String Obstacle_Dection = "eyecontact_detection.tflite";
//    private final String MODEL_YOLOV5S = "yolov5s-dynamic.tflite";
    private final String MODEL_YOLOV5N =  "yolov5n-fp16-320.tflite";
    private final String OBSTACLE_LABEL = "eyecontact_labels.txt";
    ...
    public void setModelFile(String modelFile){
        switch (modelFile) {
            case "Obstacle_Dection":
                IS_INT8 = false;
                MODEL_FILE = Obstacle_Dection;
                break;
            case "traffic":
                IS_INT8 = false;
    ...
    public void initialModel(Context activity) {
        ...
        try {
            ...
            associatedAxisLabels = FileUtil.loadLabels(activity, OBSTACLE_LABEL);
            Log.i("tfliteSupport", "Success reading label: " + OBSTACLE_LABEL);
